...
pr_vect/0.25
Re(decomp$vectors[,1])/max(Re(decomp$vectors[,1]))
```
...
```{r, message=FALSE}
library(tidyverse)
url <- paste0("https://raw.githubusercontent.com/turgeonmaxime/",
              "twitter_pagerank_STAT4690/master/", 
              "edge_list_subset.csv")
